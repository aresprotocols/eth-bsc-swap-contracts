...
contract ETHSwapAgentImpl is Context, Initializable {
    ...
    // constructor() public {
    // }
    // function initialize(uint256 fee, address payable ownerAddr)
    //     public
    //     initializer
    // {
    //     swapFee = fee;
    ...
    function registerSwapPairToBSC(address erc20Addr, address bep20Addr)
        external
        returns (bool)
    {
    ...
    function swapETH2BSC(address erc20Addr, uint256 amount)
        external
        payable
        notContract
        returns (bool)
